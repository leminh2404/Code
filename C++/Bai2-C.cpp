...
int main()
{
	...
	scanf("%f",&a);
	if(a>0) goto Nhapcanhb;
	else printf(" Sai! Nhap lai canh a");
		 goto Nhapcanha;
	Nhapcanhb:printf("\n Nhap canh b cua tam giac: ");
	scanf("%f",&b);
	if(b>0) goto Nhapcanhc;
	else printf(" Sai! Nhap lai canh b");
		 goto Nhapcanhb;
	Nhapcanhc:printf("\n Nhap canh c cua tam giac: ");
	scanf("%f",&c);
	if(c>0) goto Dieukien1;
	else printf(" Sai! Nhap lai canh c");
	     goto Nhapcanhc;
    Dieukien1:
    if (a+b>c) 
	    goto Dieukien2;
